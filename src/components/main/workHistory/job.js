...
const Job = ({data,index})=>{
    ...
    return(
        <div className='col-12 col-md-6' key={data.id}>
            <div className={['card job-description cv-card-shadow',index%2===0?'me-md-3 mt-3 mt-md-3 arrow-right':'ms-md-3 mt-3 mt-md-5 arrow-left'].join(' ')}>
                <div className='card-body'>
                    ...
                    <div className='card-text m-1'>
                        ...
                        {data.description.map((description, index)=>(
                            <li key={index}><p className='job-text-item'>{description}</p>
